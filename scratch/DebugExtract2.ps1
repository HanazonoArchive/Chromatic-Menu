...
$typedIml = [ChromaticMenu.Native.NativeMethods+IImageList]$iml
$hIcon = [IntPtr]::Zero
$hr2 = $typedIml.GetIcon($shfi.iIcon, [ChromaticMenu.Native.NativeMethods]::ILD_TRANSPARENT, [ref]$hIcon)
